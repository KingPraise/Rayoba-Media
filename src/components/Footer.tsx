      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-20 border-b border-royal-gold/15">
          ...
          <div>
            ...
            >
              <Sparkles className="w-5 h-5 text-zinc-900 group-hover:text-royal-purple transition-colors duration-300" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 py-16 border-b border-royal-gold/15 text-left">
          ...
          <div className="md:col-span-5 space-y-6 md:pr-12">
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-royal-gold/10 border border-royal-gold/20 flex items-center justify-center text-royal-purple group-hover:scale-110 transition-transform duration-500 overflow-hidden p-1.5">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a href="#" className="w-10 h-10 rounded-full border border-royal-gold/20 flex items-center justify-center text-gray-400 hover:text-royal-purple hover:border-royal-gold hover:bg-royal-gold/5 transition-all duration-300" aria-label="Instagram">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full border border-royal-gold/20 flex items-center justify-center text-gray-400 hover:text-royal-purple hover:border-royal-gold hover:bg-royal-gold/5 transition-all duration-300" aria-label="TikTok">
              ...
              <a href="#" className="w-10 h-10 rounded-full border border-royal-gold/20 flex items-center justify-center text-gray-400 hover:text-royal-purple hover:border-royal-gold hover:bg-royal-gold/5 transition-all duration-300" aria-label="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full border border-royal-gold/20 flex items-center justify-center text-gray-400 hover:text-royal-purple hover:border-royal-gold hover:bg-royal-gold/5 transition-all duration-300" aria-label="LinkedIn">
                <Linkedin className="w-4 h-4" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full border border-royal-gold/20 flex items-center justify-center text-gray-400 hover:text-royal-purple hover:border-royal-gold hover:bg-royal-gold/5 transition-all duration-300" aria-label="Twitter">
          ...
          <div className="md:col-span-2 space-y-6">
            <h4 className="font-display text-sm font-bold text-royal-purple uppercase tracking-widest">Navigation</h4>
          ...
          {/* Connect */}
          <div className="md:col-span-2 space-y-6">
            <h4 className="font-display text-sm font-bold text-royal-purple uppercase tracking-widest">Legal</h4>
            <ul className="space-y-4 font-sans text-sm text-gray-400">
              <li>
        ...
        <div className="pt-16 pb-4 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center w-full text-xs font-sans text-gray-500 pt-8 gap-4">
            ...
            <p className="flex items-center">
              Crafted with <span className="text-royal-purple px-1.5 font-mono">absolute</span> conviction.
            </p>
          </div>
        </div>
